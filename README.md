...
graph TD;
    ...
    Credenciales_Manualmente-->Equipos_a_inventariar(Equipos a inventariar);
    Credenciales_Manualmente-->Crear_Vault_Con_Credenciales;
    Equipos_a_inventariar(Equipos a inventariar)-->Red_CIDR;
    Equipos_a_inventariar(Equipos a inventariar)-->Fichero_IP;
    Equipos_a_inventariar(Equipos a inventariar)-->Introducir_IP;
